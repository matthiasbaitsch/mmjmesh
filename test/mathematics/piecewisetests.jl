@testitem "Piecewise" setup=[Validate] begin
    ...
    @test Validate.validateoperations(pw1, Sin())
    @test Validate.validateoperations(pw1, pw1)
    @test Validate.validateoperations(pw1, pw2)
    @test Validate.validateoperations(pw2, pw1)
