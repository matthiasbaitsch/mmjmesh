@testitem "Interpolations" setup=[Validate] begin
    ...
    @test m1(0) == 1.5
    @test m1(1) == 2.0
    Validate.validate(m1, atol=1e-7)
    ...
    @test m2(0) == [1.5, 3.5]
    @test m2(1) == [2, 4]
    Validate.validate(m2, atol=1e-6)
