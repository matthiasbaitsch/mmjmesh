...
```{julia}
bd = dirname(@__FILE__)
m = Mesh(bd * "/../data/gmsh/complex-g1.msh")
...
Groups can be used filter access
...
m.groups[:f1] = FaceGroup(10:20)
m.groups[:f2] = FaceGroup(50:80)
m.groups[:e1] = EdgeGroup(10:20)
m.groups[:e2] = EdgeGroup(50:60)
mplot(m) |> mconf()
```
